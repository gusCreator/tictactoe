...
public class StichWinController {
  @FXML
  ...
  private String[] frases = {
    "ACASO NO TIENES LO SUFICIENTE?",
    "HUMANO TONTO",
    "ESTOY LISTO PARA DOMINAR EL\nMUNDO",
    "ACASO PENSABAS QUE PODIAS GANAR?",
    "YA IRE POR TI",
    "CUIDATE DE LAS SOPRESAS"
  };
  ...
  public void initialize(){
    ...
    customText(title, "PERDISTE!", 70, Color.rgb(197, 1, 226));
